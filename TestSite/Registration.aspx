             ...
             <div class="container">
                 ...
                 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     <ul class="nav navbar-nav navbar-right custom-menu">
                         ...
                         <li>
                             <asp:Button ID="saveTop" runat="server" Text="Save" OnClick="submit_Click" />
                         </li>
              ...
              <%--  <div class="col-md-6 col-md-offset-3">--%>
                   <div class ="box"> 
                    ...
                    <div class="box">
                        ...
                        <asp:Button ID="submit" class="<%--btn btn-lg btn-primary btn-block --%> signup-btn" runat="server" Text="Save" OnClick="submit_Click" />
