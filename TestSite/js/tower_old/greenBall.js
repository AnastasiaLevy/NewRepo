    ...
    if (canMove) {
        if (up1 == null && up2 == null && up3 == null) {
            if (p6 == green) {
                ...
                saveTestStep({ action: 'up', ballColor: 'green', pegs: 3, position: 6 });
                up3 = green;
                p6 = null;
                checkPos(true);
                ...
                saveTestStep({ action: 'up', ballColor: 'green', pegs: 2, position: 5 });
                up = green;
                p5 = null;
                up2 = green;
                checkPos();
                ...
                saveTestStep({ action: 'up', ballColor: 'green', pegs: 2, position: 4 });
                p4 = null;
                up2 = green;
                checkPos(true);
            }
                ...
                saveTestStep({ action: 'up', ballColor: 'green', pegs: 1, position: 3 });
                up1 = green;
                p3 = null;
                checkPos();
            }
                ...
                saveTestStep({ action: 'up', ballColor: 'green', pegs: 1, position: 2 });
                up1 = green;
                p2 = null;
                checkPos();
                ...
                saveTestStep({ action: 'up', ballColor: 'green', pegs: 1, position: 1 });
                up1 = green;
                p1 = null;
                checkPos(true);
