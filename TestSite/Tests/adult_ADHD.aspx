...
<asp:Content ID="Content8" ContentPlaceHolderID="contentResearch" runat="server">
    ...
    <p><asp:Localize meta:resourcekey="Content8_paragraph4"  runat="server" ID="Localize7" Text="" /></p>

    <p><asp:Localize meta:resourcekey="Content8_paragraph5"  runat="server" ID="Localize6" Text="" /></p>
    <p><asp:Localize meta:resourcekey="Content8_paragraph6"  runat="server" ID="Localize9" Text="" /></p>

    <p><asp:Localize meta:resourcekey="Content8_paragraph7"  runat="server" ID="Localize8" Text="" /></p>

    <p><asp:Localize meta:resourcekey="Content8_paragraph8"  runat="server" ID="Localize10" Text="" /></p>
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="circle c1 img-circle" id="singlePr" runat="server">
                                ...
                                <p><asp:Localize meta:resourcekey="price_single_paragraph"  runat="server" ID="Localize13" Text="" /></p>
                        ...
                        <div class="col-md-3">
                            <div class="circle c3 img-circle">
                                <h4 class="green"><asp:Localize meta:resourcekey="price_hundred_title"  runat="server" ID="Localize16" Text=""/></h4>
                                <span class="icon green"><i class="fa fa-usd "></i></span>
                                <span class="price-large green">400</span>
                                <span class="price-small">.00</span>
                                <p><asp:Localize meta:resourcekey="price_hundred_paragraph"  runat="server" ID="Localize17" Text="" /></p>
