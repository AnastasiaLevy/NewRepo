...
<asp:Content ID="Content8" ContentPlaceHolderID="contentResearch" runat="server">
    <p><asp:Localize meta:resourcekey="Content8_paragraph1"  runat="server" ID="Localize4" Text="" /></p>

    <p><asp:Localize meta:resourcekey="Content8_paragraph2"  runat="server" ID="Localize5" Text="" /></p>
</asp:Content>
<asp:Content ID="Content9" ContentPlaceHolderID="sampleReport" runat="server">
  ...
  <p class="report"> <asp:LinkButton ID="report" runat="server"
       OnClick="report_Click"><asp:Localize meta:resourcekey="Content9_linkbtn"  runat="server" ID="Localize2" Text="" /></asp:LinkButton></p>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="circle c1 img-circle" id="singlePr" runat="server">
                                <h4 class="blue"><asp:Localize meta:resourcekey="price_single_title"  runat="server" ID="Localize3" Text="" /></h4>
