...
namespace TestSite.Tests
{
    public partial class Personality : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("../ReportsSamples/SCATI_Sample.html");
        }

        protected void single_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "SCATI", 1);
        }

        protected void ten_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "SCATI", 10);
        }

        protected void hundred_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "SCATI", 100);
        }

        protected void unlim_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "SCATI", 10000);
        }
