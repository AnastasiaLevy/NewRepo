...
namespace TestSite.Tests
{
    public partial class Autism : System.Web.UI.Page
    {
        ...
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "CASS", 1);
        }

        protected void ten_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "CASS", 10);
        }

        protected void hundred_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "CASS", 100);
        }

        protected void unlim_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "CASS", 10000);
        }
