...
<asp:Content ID="Content4" ContentPlaceHolderID="testDescription" runat="server">
    <p><asp:Localize meta:resourcekey="Content4"  runat="server" ID="Localize1" Text="" />
    </p>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="contentAbout" runat="server">
     <p><asp:Localize meta:resourcekey="Content5"  runat="server" ID="Localize2" Text="" /></p>
</asp:Content>
<asp:Content ID="Content6" ContentPlaceHolderID="contentMeasure" runat="server">
     <p><asp:Localize meta:resourcekey="Content6"  runat="server" ID="Localize3" Text="" /></p>
</asp:Content>
...
<asp:Content ID="Content9" ContentPlaceHolderID="sampleReport" runat="server">
   <p class="report"> <asp:LinkButton ID="report" runat="server"
       OnClick="report_Click"><asp:Localize meta:resourcekey="Content9_linkbtn"  runat="server" ID="Localize4" Text="" /></asp:LinkButton></p>
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="circle c1 img-circle" id="singlePr" runat="server">
                                <h4 class="blue"><asp:Localize meta:resourcekey="price_single_title"  runat="server" ID="Localize5" Text="" /></h4>
                                <span class="icon blue"><i class="fa fa-usd"></i></span>
                                <span class="price-large blue">5</span>
                                <span class="price-small">.00</span>
                                <p><asp:Localize meta:resourcekey="price_single_paragraph"  runat="server" ID="Localize6" Text="" /></p>
                        ...
                        <div class="col-md-3">
                            <div class="circle c2 img-circle">
                                <h4 class="yellow"><asp:Localize meta:resourcekey="price_ten_title"  runat="server" ID="Localize7" Text="" /></h4>
                                <span class="icon yellow"><i class="fa fa-usd"></i></span>
                                <span class="price-large yellow">40</span>
                                <span class="price-small">.00</span>
                                <p><asp:Localize meta:resourcekey="price_ten_paragraph"  runat="server" ID="Localize8" Text="" /></p>
                        ...
                        <div class="col-md-3">
                            <div class="circle c3 img-circle">
                                <h4 class="green"><asp:Localize meta:resourcekey="price_hundred_title"  runat="server" ID="Localize9" Text="" /></h4>
                                <span class="icon green"><i class="fa fa-usd "></i></span>
                                <span class="price-large green">80</span>
                                <span class="price-small">.00</span>
                                <p><asp:Localize meta:resourcekey="price_hundred_paragraph"  runat="server" ID="Localize10" Text="" /></p>
                                <asp:Button ID="hundred" class="btn btn-success" runat="server" OnClick="hundred_Click" Text="B" meta:resourcekey="price_hundred_btn"/>
                            </div>
                        </div>
                        <!-- .Col-md-3 ends here -->
                        ...
                        <div class="col-md-3">
                            <div class="circle c4 img-circle">
                                <h4 class="red"><asp:Localize meta:resourcekey="price_unlim_title"  runat="server" ID="Localize11" Text="" /></h4>
                                <span class="icon red"><i class="fa fa-usd "></i></span>
                                <span class="price-large red">499</span>
                                <span class="price-small">.00</span>
                                <p>
                                    <asp:Localize meta:resourcekey="price_unlim_paragraph"  runat="server" ID="Localize12" Text="" />
                                <p>
