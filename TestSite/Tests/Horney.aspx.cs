...
namespace TestSite.Tests
{
    public partial class Horney : System.Web.UI.Page
    {
        ...
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "HCTI", 1);
        }

        protected void ten_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "HCTI", 10);
        }

        protected void hundred_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId,"HCTI", 100);
        }

        protected void unlim_Click(object sender, EventArgs e)
        {
            string result;
            result = APICalls.BuyTest(ProviderId, "HCTI", 10000);
        }
