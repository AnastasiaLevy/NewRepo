...
;
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static bool SaveWpfTOLAppKey(string userId, string deviceIdentifier, string key)
        {
            DataTable ds = new DataTable();
            SqlConnection conn = new SqlConnection(connectionSring);
            SqlCommand cmd = new SqlCommand("SaveWpfTOLAppKey", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("License", key);
            cmd.Parameters.AddWithValue("UserId", userId);
            cmd.Parameters.AddWithValue("DeviceId", deviceIdentifier);
            ...
            {
                InsertErrorMessage(ex.ToString(), null, null, "SaveWpfTOLAppKey");
                throw new Exception("Execption Getting Saved Results. " + ex.Message);
                return false;
            }
            finally
